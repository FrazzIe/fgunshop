...
function level0()
    ...
    Menu.addButton("Knuckle dusters  ~g~$~r~600", "buyweapon", {name="Knuckle dusters", price=600,license=0,model="WEAPON_KNUCKLE"})
    Menu.addButton("Knife  ~g~$~r~550", "buyweapon", {name="Knife", price=550,license=0,model="WEAPON_KNIFE"})
    Menu.addButton("Dagger  ~g~$~r~500", "buyweapon", {name="Dagger", price=500,license=0,model="WEAPON_DAGGER"})
    Menu.addButton("Switchblade  ~g~$~r~500", "buyweapon", {name="Switchblade", price=500,license=0,model="WEAPON_SWITCHBLADE"})
    Menu.addButton("Crowbar  ~g~$~r~250", "buyweapon", {name="Crowbar", price=250,license=0,model="WEAPON_CROWBAR"})
    Menu.addButton("Bat  ~g~$~r~250", "buyweapon", {name="Bat", price=250,license=0,model="WEAPON_BAT"})
    Menu.addButton("Bottle  ~g~$~r~50", "buyweapon", {name="Bottle", price=50,license=0,model="WEAPON_BOTTLE"})
    Menu.addButton("Hammer  ~g~$~r~50", "buyweapon", {name="Hammer", price=50,license=0,model="WEAPON_HAMMER"})
end
...
function level1()
    ...
    ClearMenu()
    Menu.previous = "Main"
    Menu.addButton("Pistol ~g~$~r~2500", "buyweapon", {name="Pistol",price=2500,license=1,model="WEAPON_Pistol"})
    Menu.addButton("Pistol 50 cal ~g~$~r~5000", "buyweapon", {name="Pistol 50",price=5000,license=1,model="WEAPON_PISTOL50"})
    Menu.addButton("SNS Pistol ~g~$~r~6500", "buyweapon", {name="SNS Pistol",price=6500,license=1,model="WEAPON_SNSPistol"})
    Menu.addButton("Heavy Pistol ~g~$~r~8000", "buyweapon", {name="Heavy Pistol",price=8000,license=1,model="WEAPON_HeavyPistol"})
    Menu.addButton("Revolver ~g~$~r~9900", "buyweapon", {name="Revolver",price=9900,license=1,model="WEAPON_Revolver"})
end
...
function level3()
    ...
    ClearMenu()
    Menu.previous = "Main"
    Menu.addButton("MicroSMG ~g~$~r~65000", "buyweapon", {name="MicroSMG",price=65000,license=3,model="WEAPON_MicroSMG"})
    Menu.addButton("SMG ~g~$~r~69000", "buyweapon", {name="SMG",price=69000,license=3,model="WEAPON_SMG"})
    Menu.addButton("Assault SMG ~g~$~r~73000", "buyweapon", {name="Assault SMG",price=73000,license=3,model="WEAPON_AssaultSMG"})
    Menu.addButton("MG ~g~$~r~88000", "buyweapon", {name="MG",price=88000,license=3,model="WEAPON_MG"})
    Menu.addButton("Gusenberg ~g~$~r~95000", "buyweapon", {name="Gusenberg",price=95000,license=3,model="WEAPON_Gusenberg"})
...
function level4()
    ...
    ClearMenu()
    Menu.previous = "Main"
    Menu.addButton("Assault Rifle ~g~$~r~100000", "buyweapon", {name="Assault Rifle",price=100000,license=4,model="WEAPON_AssaultRifle"})
    Menu.addButton("Carbine Rifle ~g~$~r~120000", "buyweapon", {name="Carbine Rifle",price=120000,license=4,model="WEAPON_CarbineRifle"})
    Menu.addButton("Advanced Rifle ~g~$~r~130000", "buyweapon", {name="Advanced Rifle",price=130000,license=4,model="WEAPON_AdvancedRifle"})
    Menu.addButton("Special Carbine ~g~$~r~150000", "buyweapon", {name="Special Carbine",price=150000,license=4,model="WEAPON_SpecialCarbine"})
end
...
function MainG()
    ...
    options.menu_subtitle = ""
    ClearMenu()
    Menu.addButton("Pistol ~g~$~r~6000", "buyillegalweapon", {name="Pistol",price=6000,model="WEAPON_Pistol"})
