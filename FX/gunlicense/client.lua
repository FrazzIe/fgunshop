...
function license()
    ...
    ClearMenu()
    Menu.addButton("Level 1     ~g~$~r~25000", "buylicense", {name="Level 1", price=25000,level=1})
    Menu.addButton("Level 2     ~g~$~r~250000", "buylicense", {name="Level 2", price=250000,level=2})
    Menu.addButton("Level 3     ~g~$~r~500000", "buylicense", {name="Level 3", price=500000,level=3})
    Menu.addButton("Level 4     ~g~$~r~2000000", "buylicense", {name="Level 4", price=2000000,level=4})
end
